...
preserve pseudocode and disassembly; `callers.json` and `callees.json` preserve
exact direct call sites. The files are raw exporter output except for being
copied from the ignored `exports/` working area into this tracked evidence
directory.
